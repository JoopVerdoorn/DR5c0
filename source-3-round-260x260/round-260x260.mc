...
//!		}
	   ...
	   //! Display demo screen
		...
		if (licenseOK == true) {
      		dc.drawText(130, 40, Graphics.FONT_XTINY, "DR5c0", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
			...
			dc.drawText(179, 190, Graphics.FONT_XTINY, CCode, Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
		} else {
